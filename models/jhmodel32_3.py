...
def checkpoint(model, best_loss, epoch, LR, filename):
    ...
    torch.save(state, '3results/' + filename) #모델 가중치 저장
...
def train_model(
    ...
    if not regression:
        ...
        tensorboard_writer_mae = SummaryWriter('runs/jh/3/mae')
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        with open("3results/log_train", 'a') as logfile:
    ...
    if not fine_tune:
        ...
        checkpoint_best = torch.load('3results/regression_checkpoint_best')
